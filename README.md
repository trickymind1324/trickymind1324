...
### 🛡️ Nivetti Systems &nbsp;`Current`
**Software Engineer — Applications**

Built a comprehensive **end-to-end GUI** for configuring, managing, and monitoring **Nivetti Switches & Routers** — giving network administrators full control from a single interface.
...
**Founding member** of the software team. Designed and built the company's first product **SENS** from scratch. Optimized dev processes, cutting feature delivery time by **~30%**.
...
| 🏗️ **Architecture** | 🎨 **Frontend** | ☁️ **Cloud & DevOps** | 🔐 **Security** |
|:---:|:---:|:---:|:---:|
| Microservices | React / Next.js | AWS Infrastructure | NDR Products |
| Event-Driven Design | React Native Mobile | Docker & CI/CD | Network Compliance |
| Distributed Systems | Responsive UI/UX | Logstash Pipelines | Threat Detection |
| API Design | Design Systems | Monitoring & Logs | Audit Automation |
