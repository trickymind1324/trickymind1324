...
<!-- HEADER -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:161b22,100:1f6feb&height=220&section=header&text=Sunny&fontSize=80&fontColor=58a6ff&fontAlignY=32&desc=Software%20Engineer%20%7C%20Backend%20%26%20Distributed%20Systems%20%7C%20Agentic%20AI&descSize=18&descColor=8b949e&descAlignY=58&animation=fadeIn" width="100%"/>
...
```yaml
name: Sunny
role: Software Engineer @ Nivetti Systems
experience: 3+ years
location: Bengaluru, India 🇮🇳
education: B.E. in Computer Science

currently:
  building: Agentic AI systems with LangGraph, LLMs & MCP
...
### 🛡️ Nivetti Systems &nbsp;`Dec 2023 – Present`
**Software Engineer — Applications**

Designing **agentic AI systems** with LangGraph, LLMs & MCP — turning research-stage primitives into production features. Optimized **NDR microservices** for throughput and tail latency under real-time packet inspection; shipped resilient APIs and pipelines (Python, Go, FastAPI, Kafka/RabbitMQ), the end-to-end **switch/router management GUI**, and the **NECS** compliance-audit tool.

</td>
<td width="50%" valign="top">

### ⚡ EMO.energy &nbsp;`Feb – Nov 2023`
**Software Engineer — Full Stack**

**Founding software engineer** — owned architecture and delivery of the company's first product, **SENS**, from zero to one. Designed the distributed backend (FastAPI, Redis, MongoDB on AWS), led the team to first production release, and cut feature delivery time by **~30%**.
...
![AWS Cloud Architecting](https://img.shields.io/badge/AWS-Cloud_Architecting-FF9900?style=for-the-badge&logo=amazonaws&logoColor=white)
![AWS Cloud Foundations](https://img.shields.io/badge/AWS-Cloud_Foundations-FF9900?style=for-the-badge&logo=amazonaws&logoColor=white)
![CCNA Routing & Switching](https://img.shields.io/badge/Cisco-CCNA_Routing_&_Switching-1BA0D7?style=for-the-badge&logo=cisco&logoColor=white)
![CCNA Intro to Networks](https://img.shields.io/badge/Cisco-CCNA_Intro_to_Networks-1BA0D7?style=for-the-badge&logo=cisco&logoColor=white)
...
| 🤖 **AI Systems** | 🏗️ **Backend & Distributed** | ☁️ **Cloud & DevOps** | 🔐 **Security** |
|:---:|:---:|:---:|:---:|
| LangGraph Agent Pipelines | Microservices & API Design | AWS Infrastructure | NDR Products |
| MCP Tool Orchestration | Kafka / RabbitMQ Pipelines | Docker & CI/CD | Network Compliance |
| Schema-Enforced LLM Outputs | p99 Latency Optimization | Observability & Logs | Threat Detection |
| Eval Harnesses & Guardrails | Event-Driven Design | Logstash Pipelines | Audit Automation |
...
[![Email](https://img.shields.io/badge/Send_a_mail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:sunnyas1824@gmail.com)
